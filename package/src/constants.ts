...
export const DEFAULT_MEMORY_CACHE_MAX: number = 100; // 15m
export const DEFAULT_CLASS_NAME: string = 'UnknownClassName';
export const DEFAULT_FUNCTION_ARGS_POSTFIX: string = 'EmptyArgs';
